    ...
    return Container(
      margin: EdgeInsets.only(bottom: 10),
        child: ListTile(
          ...
          leading: Icon(todo.isDone? Icons.check_box_outlined: Icons.check_box_outline_blank_outlined, color: tdBlue),
          ...
          trailing: Container(
            ...
            child: IconButton(color: Colors.white, iconSize: 18, icon: Icon(Icons.delete_outline),
